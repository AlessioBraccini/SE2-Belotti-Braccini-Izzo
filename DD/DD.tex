...
\begin{itemize}
    ...
    PostreSQL has been selected as the main database infrastructure, this allow to manage easily and in a secure way all the data sources.
...
\begin{figure}[H]
    \centering
    \subfloat[\centering MapServiceManager]{{\includegraphics[scale=0.5]{assets/Test/farmLocationTest.png} }}%
    \qquad\qquad
    \subfloat[\centering WeatherManager]{{\includegraphics[scale=0.5]{assets/Test/weatherTest.png} }}%
