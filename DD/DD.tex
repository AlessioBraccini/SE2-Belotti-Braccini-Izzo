...
\subsection{Other design decisions}
    %\subsubsection{Servers availability and response time} moltiplicare i server and load balancer
    %\subsubsection{Farmers ranking creation} Only the ratio harvested/plant?
    %\subsubsection{Farmers location} GPS coordinates?
    %\subsubsection{Agronomist daily plan}  maybe the 23:59 stuff?
