...
\begin{center}
    \begin{figure}[H]
        \includegraphics[scale=0.25, center]{assets/SequenceDiagram/SignUp.png}
...
\begin{center}
    \begin{figure}[H]
        \includegraphics[scale=0.4, center]{assets/SequenceDiagram/Report.png}
...
\begin{center}
    \begin{figure}[H]
        \includegraphics[scale=0.7, center]{assets/SequenceDiagram/Soil.png}
...
\begin{center}
    \begin{figure}[H]
        \includegraphics[scale=0.7, center]{assets/SequenceDiagram/Irrigation.png}
...
\begin{center}
    \begin{figure}[H]
        \includegraphics[scale=0.8, center]{assets/SequenceDiagram/Ranking.png}
...
\begin{center}
    \begin{figure}[H]
        \includegraphics[scale=0.8, center]{assets/SequenceDiagram/SpecificFarmerInfo.png}
...
\begin{center}
    \begin{figure}[H]
        \includegraphics[scale=0.75, center]{assets/SequenceDiagram/InsertProduction.png}
...
\begin{center}
    \begin{figure}[H]
        \includegraphics[scale=0.4, center]{assets/SequenceDiagram/CheckNews.png}
        \caption{Check News}
        \label{fig: news}
    \end{figure}
\end{center}
...
The NewsManager uses the NewsService component in order to get always up-to-date news.

\newpage
\textbf{Forum}
\begin{center}
    \begin{figure}[H]
        \includegraphics[scale=0.4, center]{assets/SequenceDiagram/Forum.png}
...
\begin{center}
    \begin{figure}[H]
        \includegraphics[scale=0.3, center]{assets/SequenceDiagram/Forecast.png}
...
The WeatherManager component uses the WeatherForecastService component in order to get always up-to-date forecast.

\newpage
\textbf{Help Request Interaction}
\begin{center}
    \begin{figure}[H]
        \includegraphics[scale=0.3, center]{assets/SequenceDiagram/HelpRequest.png}
...
\begin{center}
    \begin{figure}[H]
        ...
        \includegraphics[scale=0.45, center]{assets/SequenceDiagram/DailyPlan.png}
