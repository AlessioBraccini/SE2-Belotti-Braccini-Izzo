...
\begin{center}
    \begin{figure}[H]
        \includegraphics[scale=0.67, center]{assets/application-server-component.png}
...
\begin{center}
    \begin{figure}[H]
        \includegraphics[scale=0.75, center]{assets/SequenceDiagram/ViewInitiativeReport.png}
...
\begin{center}
    \begin{figure}[H]
        \includegraphics[scale=0.45, center] {assets/SequenceDiagram/uploadReport.png}
...
\begin{longtable}{|c|c|c|c|c|c|c|c|c|c|c|c|c|c|}
    ...
    \cellcolor{SpringGreen!50}R21 & &&&& x &&&x &&&&&\\\hline
