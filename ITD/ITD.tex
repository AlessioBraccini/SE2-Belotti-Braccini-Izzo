...
\begin{itemize}
    ...
    \item \textbf{config.js}: contains the url of the backend server.
...
Firstly you have to specify in the config.js file if you want to run the backend online or locally in your device.
Inside the file you will find a configuration string and you have to insert the url of the backend
(some choices are already available).
