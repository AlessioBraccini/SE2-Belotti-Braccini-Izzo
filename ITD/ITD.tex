...
the three main blocks of a web application.
The structure of a Vue file is intuitive, it is compose by three blocks:
\begin{itemize}
    \item HTML: where you can write the structure of the component.
    \item JavaScript: where you can insert the interactive part of the component.
    \item CSS: where you can insert the style of the HTML structure, it can be scoped to the actual component or not.
\end{itemize}
...
\begin{itemize}
    ...
    \begin {itemize}
        ...
        \item \textbf{router}: it contains the JavaScript file that list all the routes used to navigate the front-end.
        \item \textbf{views}: it contains all the vue component needed by the front-end.
...
When the build process is finish the web ready files are put in the dist directory.
...
As a web application (we decide to host the project on a real server and) a completely running version of this software is available on: \url{https://dreamapplication.herokuapp.com/}.
...
\begin{itemize}
    \item [1] Download from the \href{https://github.com/AlessioBraccini/SE2-Belotti-Braccini-Izzo}{\textbf{Github repository}} the \textit{dist} folder
    \item [2] Open the terminal in the dist folder
    \item [3] Type \texttt{serve dist}
