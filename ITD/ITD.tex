...
Given the three types of user, we decided to implement the functionalities for Policy Maker users and Agronomist user. In particular:
\subsubsection*{Policy Maker}
\begin{itemize}
    \item Farmers ranking of the whole region or grouped by district
    \item Visualization of humidity and water irrigation sensors data display
    for simplicity as graphs
...
\begin{itemize}
    ...
    \item Weather widget
\end{itemize}
For the details about these functionalities please read the RASD document.
\newpage
...
The hosting service we chose is Heroku that is a platform as a service (PaaS)
