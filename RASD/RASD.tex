...
\end{itemize}
\footnotetext{This constraint is purposely stronger than what it could be in order to simplify a future implementation of the prototype that won't allow local storaging of data while the device is not connected to internet. It could be relaxed in a further release of the application.}
\newpage
