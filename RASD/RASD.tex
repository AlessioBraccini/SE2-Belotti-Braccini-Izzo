...
\paragraph{Use Cases Diagram}
    ...
    \paragraph{Use Cases Description}
        ...
        \begin{itemize}
            ...
            \begin{table}[H]
                \item[] \textbf{Manage Daily Plan}
                \item[] 
                \centering
                \begin{tabular}{|c| m{.69\textwidth}|}
                    \hline
                    \textbf{Use Case} & Manage Daily Plan\\ \hline
                    \textbf{Actor} & Agronomist\\ \hline
                    \textbf{Entry condition} & User want to manage its daily plan\\  \hline
                    \textbf{Flow of events} & \begin{enumerate}
                                                \item Press the daily "Daily Plan" button
                                                \item Choose the farmers that he want to visit during the day
                                                \item Check if the fdarmers has at least two visit
