...
\begin{itemize}
    \item \textbf{(G3) Visualize the result of steering initiatives}: it is modelled as an assertion that checks the ability of the system to retrieve all the reports written by the agronomists and present them to each policy maker. %NOT TRUE ANYMORE: CREATE A PRED/ASSERT
...
\section{Effort Spent}
    \begin{tabular}{| c || c | c| c| c |}
        ...
        Ottavia Belotti & 2.5h & 5h & 10.5h & 9h \\
