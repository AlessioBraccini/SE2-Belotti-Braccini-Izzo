...
\begin{itemize}
    ...
    \end{itemize}
    \item Version 1.4: final update before the release
    \begin{itemize}
        \item[--] Update use case description about the steering initiatives
        \item[--] Add a new sequence diagram about uploading a report
        \item[--] Add a new requirement (R21)
    \end{itemize}
\end{itemize}
...
\begin{center}
    ...
    \end{figure}
\end{center}
    \item \textbf{Write Steering Initiatives:} let the agronomists upload their
    steering initiative reports regarding the general result of the applied strategies.
\end{itemize}
...
\begin{longtable}{|c|p{0.69\textwidth}|}
    ...
    \stepcounter{RequirementCtr}
    R\arabic{RequirementCtr}    & The system must allow Policy Makers to upload their steering initiative reports to the database.\\\hline      
\end{longtable}
...
\begin{table}[H]
    \begin{center}
        \begin{tabular}{|c | p{0.69\textwidth}|}
            ...
            \cellcolor{SpringGreen!50}R21 & The system must allow Policy Makers to upload their steering initiative reports to the database.\\\hline
        \end{tabular}
    \end{center}
\end{table}
\begin{table}[H]
...
\end{itemize}
    ...
    For more details regarding specifics interactions between DREAM app and user see the sequence diagrams in section \ref{sequencediagram}.
        ...
        \newpage
            ...
            \begin{table}[H]
                \item[] \textbf{Upload Steering Initiative}
                \item[]
                \centering
                \begin{tabular}{|c |m{.69\textwidth}|}
                    \hline
                    \textbf{Use Case} & Upload a Steering initiative report\\ \hline
                    \textbf{Actor} & Agronomist\\ \hline
                    \textbf{Entry condition} & User wants to upload a report\\  \hline
                    \textbf{Flow of events} & \begin{enumerate}
                                                  \item User presses the "Steering Initiative" button
                                                  \item User chooses the pdf he wants to upload
                                                  \item User uploads the pdf
                                                  \item User presses the "Submit" button
                                                  \item System shows a confirmation message
                    \end{enumerate}\\ \hline
                    \textbf{Exit condition} & System displays a confirmation message\\ \hline
                    \textbf{Exceptions} & \begin{enumerate}
                                              \item Internet connection isn't working
                                              \item File is not a pdf
                                              \item File is bigger than 5MB
                    \end{enumerate}
                    An error message is shown and the flow of events starts again from point 1\\ \hline
                \end{tabular}
            \end{table}
        ...
        \item[] \begin{longtable}{|p{0.31\textwidth}|p{0.69\textwidth}|}
                    ...
                    \cellcolor{SpringGreen!50}\textbf{3)View Initiative Reports}\centering &  R1) The system must allow only registered and logged-in users to use the app.
                                                                                              ...
                                                                                              R6) The system must allow Policy Makers to retrieve all agronomists' steering initiative reports uploaded to the database.\\\hline
                    ...
                    \cellcolor{SpringGreen!50}\textbf{18)Upload Steering Initiative}\centering&  R1) The system must allow only registered and logged-in users to use the app.

                                                                                                R4) The system must inform the user to try later if they are experimenting connectivity issues.
                                                                                                
                                                                                                R21)The system must allow Policy Makers to upload their steering initiative reports to the database.\\\hline
    ...
    \end{itemize}
        ...
        \begin{itemize}
            ...
            \begin{center}
                  \begin{figure}[H]
                      \includegraphics[scale=0.7, center]{assets/Sequence diagrams/Agronomist/Upload_Report.png}
                      \caption{Agronomists - View Farmers Area Ranking Sequence Diagram}
                      \label{fig: sdAgronomist_writeReport}
                  \end{figure}
            \end{center}
        \end{itemize}
        \newpage
...
\begin{center}
    \begin{figure}[H]
        ...
        \caption{Predicate requestHelpAndGetResponse}
