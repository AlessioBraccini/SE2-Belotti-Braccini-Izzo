...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item Here the policy maker can find useful contact informations such as phone number (if it has been given by the farmer) and email
        \item He takes note of the desirable contact informations and closes the app
    \end{itemize}
