...
\paragraph{Use Cases Diagram}
    ...
    \paragraph{Use Cases Description}
        ...
        \begin{itemize}
            ...
            \begin{center}
                \begin{figure}[H]
                    \includegraphics[scale=0.55, center]{assets/Sequence diagrams/Sign Up.png}
            ...
            \begin{center}
                \begin{figure}[H]
                    \includegraphics[scale=0.55, center]{assets/Sequence diagrams/Log In.png}
            ...
            \begin{center}
                \begin{figure}[H]
                    \includegraphics[scale=0.55, center]{assets/Sequence diagrams/View Initiatives Report.png}
            ...
            \begin{center}
                \begin{figure}[H]
                    \includegraphics[scale=0.55, center]{assets/Sequence diagrams/Check Soil Humidity Data.png}
            ...
            \begin{center}
                \begin{figure}[H]
                    \includegraphics[scale=0.55, center]{assets/Sequence diagrams/Check water irrigation Data.png}
            ...
            \begin{center}
                \begin{figure}[H]
                    \includegraphics[scale=0.55, center]{assets/Sequence diagrams/View Farmers Ranking.png}
            ...
            \begin{center}
                \begin{figure}[H]
                    \includegraphics[scale=0.55, center]{assets/Sequence diagrams/View Specific Farmer Informations .png}
            ...
            \begin{center}
                \begin{figure}[H]
                    \vspace{-120px}
                    \includegraphics[scale=0.47, center]{assets/Sequence diagrams/Profile Edit.png}
            ...
            \begin{center}
                \begin{figure}[H]
                    \includegraphics[scale=0.55, center]{assets/Sequence diagrams/Insert Production Data.png}
            ...
            \begin{center}
                \begin{figure}[H]
                    \includegraphics[scale=0.55, center]{assets/Sequence diagrams/Check News.png}
            ...
            \begin{center}
                \begin{figure}[H]
                    \includegraphics[scale=0.55, center]{assets/Sequence diagrams/Post in the Forum.png}
            ...
            \begin{center}
                \begin{figure}[H]
                    \includegraphics[scale=0.55, center]{assets/Sequence diagrams/Check Weather Forecast.png}
            ...
            \begin{center}
                \begin{figure}[H]
                    \includegraphics[scale=0.55, center]{assets/Sequence diagrams/Send an Help Request.png}
        ...
        \begin{itemize}
            ...
            \begin{center}
                \begin{figure}[H]
                    \includegraphics[scale=0.60, center]{assets/Sequence diagrams/Agronomist/confirmDailyPlan.png}
                    \caption{Agronomist Sequence Diagram - Confirm Daily Plan}
            ...
            \begin{center}
                \begin{figure}[H]
                    \includegraphics[scale=0.55, center]{assets/Sequence diagrams/Agronomist/updateDailyPlan.png}
                    \caption{Agronomist Sequence Diagram - Update Daily Plan}
            ...
            \begin{center}
                \begin{figure}[H]
                    \includegraphics[scale=0.65, center]{assets/Sequence diagrams/Agronomist/manageFarmersRequest.png}
                    \caption{Agronomist Sequence Diagram - Manage Farmers Request}
            ...
            \begin{center}
                \begin{figure}[H]
                    \includegraphics[scale=0.65, center]{assets/Sequence diagrams/Agronomist/insertResponsibilityArea.png}
                    \caption{Agronomist Sequence Diagram - Insert Responsability Area}
            ...
            \begin{center}
                \begin{figure}[H]
                    \includegraphics[scale=0.60, center]{assets/Sequence diagrams/Agronomist/checkWeatherForecast.png}
                    \caption{Agronomist Sequence Diagram - Check Weather Forecast}
            ...
            \begin{center}
                \begin{figure}[H]
                    \includegraphics[scale=0.65, center]{assets/Sequence diagrams/Agronomist/viewFarmersAreaRanking.png}
                    \caption{Agronomist Sequence Diagram - View Farmers Area Ranking}
