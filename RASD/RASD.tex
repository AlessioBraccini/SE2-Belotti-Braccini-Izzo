...
\begin{itemize}
    ...
    \item \stepcounter{assumptionCtr}D\arabic{assumptionCtr}: Each Telangana's district has one and only one Agronomist
\end{itemize}
\newpage
...
\begin{longtable}{|c|p{0.69\textwidth}|}
    ...
    \stepcounter{RequirementCtr}
    R\arabic{RequirementCtr}    & \textcolor{red}{DELETE} The system must allow the users to change their location.\\\hline
    \stepcounter{RequirementCtr}
...
\begin{table}[H]
    \begin{center}
        \begin{tabular}{|c | p{0.69\textwidth}|}
            ...
            \cellcolor{SpringGreen!50}R9 & The system must notify Agronomists of unresolved requests of help from Farmers\\\hline
            ...
            \cellcolor{SpringGreen!50}R18 & The system shall allow users to be identified by an email of their choosing\\\hline
            \cellcolor{SpringGreen!50}R19 & The system must give Agronomists up-to-date ranking of the best and worst performing farmers in their responsibility area\\\hline
        \end{tabular}
    \end{center}
\end{table}
...
\begin{table}[H]
    \begin{center}
        \begin{tabular}{|c | p{0.69\textwidth}|}
            ...
            \cellcolor{SpringGreen!50}R12 & If users are experimenting connectivity issues, the system must inform them to try later.\\\hline
            \cellcolor{SpringGreen!50}R18 & The system shall allow users to be identified by an email of their choosing\\\hline
            \cellcolor{SpringGreen!50}R19 & The system must give Agronomists up-to-date ranking of the best and worst performing farmers in their responsability area\\\hline
        \end{tabular}
    \end{center}
\end{table}
...
\begin{table}[H]
    \begin{center}
        \begin{tabular}{|c | p{0.69\textwidth}|}
            ...
            \cellcolor{pink!50}D12 & Users own an IT device to connect to the application\\\hline
            \cellcolor{SpringGreen!50}R1 & The system must allow only registered and logged-in users to use the app.\\\hline
            \cellcolor{SpringGreen!50}R2 & If the IT device is equipped with GPS technology, then the system must suggest to the users the area in which they are during the registration phase. In any case, the final decision will be up to the registering user\\\hline
            \cellcolor{SpringGreen!50}R3 & The system must allow the users to change their location\\\hline
    ...
    \paragraph{Use Cases Description}
        ...
        \item[] \begin{longtable}{|p{0.31\textwidth}|p{0.69\textwidth}|}
                    ...
                    \cellcolor{SpringGreen!50}\textbf{19)View Farmers Area Ranking}\centering&  R1) The system must allow only registered and logged-in users to use the app.
                                                                                       ...
                                                                                       R19) The system must give Agronomists up-to-date ranking of the best and worst performing farmers in their responsibility area.\\\hline
